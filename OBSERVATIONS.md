...
| 2 | 2026-02-24 | Well metadata import uses practical field values (`Inactive`, `Water Injector`, `--`, `Unassigned`) that should map cleanly. | high | done | Added placeholder filtering and domain alias mapping: `Inactive -> shut_in`, `Water Injector -> injection`, and dropped placeholder tokens before validation. | 14bfd28 |
