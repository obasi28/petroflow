...
async def _assert_success(client: AsyncClient, method: str, url: str, **kwargs) -> dict:
...
def test_dca_create_list_detail_serialization_regression() -> None:
    ...
    asyncio.run(_run_regression_flow())


async def _run_regression_flow() -> None:
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        register = await _assert_success(
            client,
            "POST",
        ...
        created_well = await _assert_success(
            client,
            "POST",
            "/api/v1/wells",
            headers=headers,
        ...
        created_analysis = await _assert_success(
            client,
            "POST",
